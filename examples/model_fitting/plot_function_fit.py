"""
================================
Fitting a function with microstruktur
================================

Microstruktur contains a number of tools for fitting functions to
data. This example shows us how to load data into python, fit
a function to our datapoints with microstruktur, and then plot the
result.
...
# ------------
#
# First, we'll load some data into microstruktur.
...
# ---------------
#
# With microstruktur, models are created with the :ref:Model class.

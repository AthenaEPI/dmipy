...
- [Single-Shell (1 shell + b0) Multi-Tissue CSD [Dhollander et al. 2016b]](https://github.com/AthenaEPI/dmipy/blob/master/examples/example_single_shell_three_tissue_csd.ipynb)

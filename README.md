...
- [Visualization Fiber Orientation Distributions (FODs) of dispersped models](https://github.com/AthenaEPI/microstruktur/blob/master/examples/tutorial_visualizing_fods_from_dispersed_models.ipynb)
